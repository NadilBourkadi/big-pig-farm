...
_FACE_TEMPLATE: PixelGrid = [
    ...
    [ T,   "dark","fur",  "fur", "dark", "fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur","dark","dark","dark","dark","fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur","dark", "fur", "fur", "fur","dark", T,     T    ],  # 17 chin outline + body starts
    ["dark","fur",  "fur",  "fur", "fur", "dark","dark","fur", "belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","fur","dark","dark", "fur", "fur", "fur", "fur","dark"],  # 18 chin curves into body
    ["fur",  "fur",  "fur", "fur", "fur", "fur", "fur", "belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","fur", "fur", "fur", "fur", "fur", "fur", "fur"],  # 19 chubby body
