...
_FACE_TEMPLATE: PixelGrid = [
    ...
    [ T,     T,     T,    "dark","fur","dark","fur",  "fur", "fur","dark","dark","dark","dark", "fur", "fur", "fur", "fur", "fur", "fur","dark","dark","dark","dark", "fur", "fur", "fur","dark","fur","dark", T,     T,     T    ],  # 9  below eyes (outline bottom)
    ...
    [ T,    "dark","fur", "fur","dark","fur", "fur",  "fur", "fur", "fur", "fur", "fur", "fur", "fur","nose","nose","nose","nose","fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur", "fur","dark","fur", "fur","dark", T    ],  # 11 nose pad + cheek tufts
