...
_FACE_TEMPLATE: PixelGrid = [
    ...
    [ T,     T,     T,     T,     T,     T,   "dark","fur", "fur", "belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","fur", "fur","dark", T,     T,     T,     T,     T,     T    ],  # 22 body starts wide
    [ T,     T,     T,     T,     T,   "dark","fur", "fur", "belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","fur", "fur","dark", T,     T,     T,     T,     T    ],  # 23 body widens
    [ T,     T,     T,     T,   "dark","fur", "fur", "fur", "belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","belly","fur", "fur", "fur","dark", T,     T,     T,     T    ],  # 24 full body
    [ T,     T,     T,     T,   "dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark","dark", T,     T,     T,     T    ],  # 25 body bottom
]
# fmt: on
