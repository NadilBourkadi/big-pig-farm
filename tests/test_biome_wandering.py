...
from big_pig_farm.simulation.behavior_movement import bias_wander_directions, get_biome_wander_target
...
class TestGetBiomeWanderTarget:
    """Tests for get_biome_wander_target()."""
    ...
    def test_color_takes_priority_over_preferred_biome(self):
        ...
        target, is_color = get_biome_wander_target(controller, pig)
    ...
    def test_picks_closest_area_when_multiple(self):
        ...
        target, _is_color = get_biome_wander_target(controller, pig)
        assert target.name == "Meadow Near"


class TestBiasWanderDirections:
    """Tests for bias_wander_directions()."""
    ...
    def test_outside_bias_toward_area(self):
        ...
        for _ in range(2000):
            result = bias_wander_directions(controller, pig, target_area)
